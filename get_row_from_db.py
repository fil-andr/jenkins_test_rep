...
engine = sa.create_engine('postgresql://postgres:pswd_123@postgres_db:5432/postgres')
...
def db_select(id_num):
    ...
    return f'---TEST_message_POLL SCM_trigger test variable  name: {d.name}, salary: {d.salary}'
